...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.init_resource::<Viewport>()
            ...
            .add_systems(
                Update,
                pause_menu::toggle_pause_system.run_if(in_state(GameState::Playing)),
            )
            .add_systems(
                Update,
        ...
        #[cfg(feature = "dev")]
        {
            app.init_resource::<dev_menu::DevTriggerState>()
                ...
                .add_systems(
                    Update,
                    dev_menu::toggle_dev_menu.run_if(in_state(GameState::Playing)),
                )
                .add_systems(
                    Update,
...
fn apply_layout(win_w: f32, win_h: f32, ui_scale: &mut UiScale, viewport: &mut Viewport) {
