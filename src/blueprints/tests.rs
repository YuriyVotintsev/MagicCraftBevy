use super::blueprint_def::BlueprintDefRaw;
use super::context::ProvidedFields;
use super::components::ComponentDefRaw;
...
fn load_all_defs() -> (HashMap<String, BlueprintDefRaw>, HashSet<String>) {
    ...
    for path in &files {
        ...
        let raw: BlueprintDefRaw = ron::from_str(&content)
