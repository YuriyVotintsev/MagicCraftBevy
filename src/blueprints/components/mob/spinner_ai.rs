...
use crate::blueprints::components::mob::spinner_charge::SpinnerCharge;
use crate::blueprints::components::mob::spinner_windup::SpinnerWindup;
...
pub struct SpinnerAi {
    ...
    #[raw(default = 3.0)]
    pub windup_duration: ScalarExpr,
    #[raw(default = 1.0)]
    pub charge_duration: ScalarExpr,
    #[raw(default = 0.5)]
    pub cooldown_duration: ScalarExpr,
    #[raw(default = 1200.0)]
    pub charge_speed: ScalarExpr,
}
